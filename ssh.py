...
"""
Please enjoy our free ssh server
: git pull
...
try:
	...
	exit("\n\x1b[1;97m[\x1b[1;91m!\x1b[1;97m] NOT ALL MODULE INSTALLED\n    PLEASE READ README.md\n")
...
def Membuat_ssl(id, cookies, user, pw, server):
	...
	if "Fuck Your Account has been successfully created !" in posd:
		...
		exit("  \x1b[1;97m[\x1b[1;91m*\x1b[1;97m] USERNAME New age hacking family\n")
	else:
		exit("  \x1b[1;97m[\x1b[1;91m+\x1b[1;97m] YOU HAVE CREATED ACCOUNT THROUGHOUT THE LIMIT\n")
...
def Membuat_ssh(id, cookies, user, pw, server):
	...
	if "Fuck Your Account has been successfully created !" in posd:
		print("  \x1b[1;91m>>> \x1b[1;97mACCOUNT \x1b[1;92mDAN \x1b[1;97mMAFFIA")
		print("  \x1b[1;91m> \x1b[1;97mUSERNAME \x1b[1;91m:\x1b[1;92m "+re.search("Username\s\s:\s(.*?)<br>", str(posd)).group(1))
		print("  \x1b[1;91m> \x1b[1;97mPASSWORD \x1b[1;91m:\x1b[1;92m "+re.search("Password\s\s:\s(.*?)<br>", str(posd)).group(1))
		print("  \x1b[1;91m> \x1b[1;97mHOST     \x1b[1;91m:\x1b[1;92m "+re.search("Host\sIP\s\s\s:\s(.*?)<br>", str(posd)).group(1))
...
class SSL_TLS:
	...
	def Chek(self):
		...
		while self.pilih == "":
			print(" \x1b[1;91m >>>\x1b[1;97m YA Enjoy our service\x1b[1;91m!")
			self.pilih = input("  \x1b[1;97m>>> ")
		try:
			chekin = self.link[int(self.pilih) - 1]
		except (ValueError, IndexError):
			exit("  \x1b[1;97m[\x1b[1;91m!\x1b[1;97m] ENTER THE NUMBER ENJOY..")
...
class SSH:
	...
	def Chek(self):
		...
		try:
			...
			exit("  \x1b[1;97m[\x1b[1;91m!\x1b[1;97m] ENTER THE NUMBER ..")
		cek_2 = par(get(chekin).text, "html.parser")
		if cek_2.find("div", class_="progress-bar progress-bar-danger") is None:
			serverid = cek_2.find('input', {"type":"hidden"}).get("value")
			cookie = re.search("PHPSESSID=(\w+)\sfor", str(get(chekin).cookies)).group(1)
...
def Menu():
   ...
   \x1b[1;93m ╔═╗╦═╗╔═╗╔═╗╔╦╗╔═╗  ╔═╗╔═╗╦ ╦
    ║  ╠╦╝║╣ ╠═╣ ║ ║╣   ╚═╗╚═╗╠═╣
    ╚═╝╩╚═╚═╝╩ ╩ ╩ ╚═╝  ╚═╝╚═╝╩ ╩
\x1b[1;97m     https://t.m/danmaffiayounghack
\x1b[1;91m+-----------------------------------+
\x1b[1;96m  {\x1b[1;92m01\x1b[1;96m} \x1b[1;97mCREATE Dan Maffia SSL/TLS MONTHLY 
\x1b[1;96m  {\x1b[1;92m02\x1b[1;96m} \x1b[1;97mCREATE Dan Maffia SSH MONTHLY
\x1b[1;96m  {\x1b[1;91m00\x1b[1;96m} \x1b[1;91mGET THE FUCK OUT OF HERE WE DON'T NEED YOU ANYMORE
\x1b[1;91m+-----------------------------------+""")
	pilih = input("  \x1b[1;97m>>> \x1b[1;92m")
	while pilih == "":
		print(" \x1b[1;91m >>>\x1b[1;97m Support our channel Support our channel https://t.me/danmaffiayounghack\x1b[1;91m!")
		pilih = input("  \x1b[1;97m>>> \x1b[1;92m")
	if pilih in ("1","01"):
		nice = SSL_TLS
	elif pilih in ("2","02"):
		...
		exit("\x1b[1;91m+-----------------------------------+\n \x1b[1;97mDan Maffia TOOL\n")
	else:
		exit(" \x1b[1;91m >>> \x1b[1;97mSORRY MENU \x1b[1;91m'\x1b[1;97m"+pilih+"\x1b[1;91m'\x1b[1;97m NOT FOUND\n")
	print("\x1b[1;91m+-----------------------------------+")
	nice().Chek()
